...
### LOAD DATA ###
#################
subjData <- readRDS("/data/jux/BBL/projects/pncHeterogeneity/subjectData/n1141_DepAnxTd_t1_subjData.rds")
...
### MERGE DATA ###
##################
dataComb <-merge(subjData, hydraData, by="bblid")
...
### SAVE DATA ###
#################
saveRDS(dataComb, "/data/jux/BBL/projects/pncHeterogeneity/subjectData/MergedWithHYDRA/n1141_DepAnxTd_t1_hydra_subjData.rds")
