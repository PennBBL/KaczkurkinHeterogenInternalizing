...
SigRegions = csvread('/data/jux/BBL/projects/pncHeterogeneity/subjectData/Tvalues/t_index_ct_S2vsTd.csv');
...
ResultantFile = '/data/jux/BBL/projects/pncHeterogeneity/images/ct_signifRegions_S2vsTd.nii';
