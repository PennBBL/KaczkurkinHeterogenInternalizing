...
SigRegions = csvread('/data/jux/BBL/projects/pncHeterogeneity/subjectData/Tvalues/t_index_dtiTr_S2vsTd.csv');
...
ResultantFile = '/data/jux/BBL/projects/pncHeterogeneity/images/dtiTr_signifRegions_S2vsTd.nii';
