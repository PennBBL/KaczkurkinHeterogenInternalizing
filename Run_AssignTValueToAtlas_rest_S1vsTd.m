...
SigRegions = csvread('/data/jux/BBL/projects/pncHeterogeneity/subjectData/Tvalues/t_index_restAlff_S1vsTd.csv');
...
ResultantFile = '/data/jux/BBL/projects/pncHeterogeneity/images/restAlff_signifRegions_S1vsTd.nii';
