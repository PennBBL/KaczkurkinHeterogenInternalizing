...
SigRegions = csvread('/data/jux/BBL/projects/pncHeterogeneity/subjectData/Tvalues/t_index_vol_S2vsTd.csv');
...
ResultantFile = '/data/jux/BBL/projects/pncHeterogeneity/images/vol_signifRegions_S2vsTd.nii';
