##############################################
#### SENSITIVITY ANALYSES WITH DTI SAMPLE ####
##############################################
...
subjData <- readRDS("/data/jux/BBL/projects/pncHeterogeneity/subjectData/MergedWithHYDRA/n836_DepAnxTd_dti_hydra_noMeds_subjData.rds")
...
write.table(dtiTr_omnibus_signif, file = "/data/jux/BBL/projects/pncHeterogeneity/tablesFigures/pfdr_omnibus_dtiTr_noMeds.csv", sep = ",", row.names = FALSE, col.names = TRUE, quote=FALSE)
...
write.table(dtiTr_pairwise_signif, file = "/data/jux/BBL/projects/pncHeterogeneity/tablesFigures/pfdr_pairwise_dtiTr_noMeds.csv", sep = ",", row.names = FALSE, col.names = TRUE, quote=FALSE)
